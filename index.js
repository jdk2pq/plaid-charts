...
dotenv.config({path: path.resolve(process.cwd(), `.${PLAID_ENV}.env`)});
...
var PLAID_COUNTRY_CODES = process.env.PLAID_COUNTRY_CODES || 'US,CA,GB,FR,ES';

// We store the access_token in memory - in production, store it in a secure
// persistent data store
var ACCESS_TOKEN = process.env.ACCESS_TOKEN || undefined;
var PUBLIC_TOKEN = null;
var ITEM_ID = process.env.ITEM_ID || undefined;
...
app.get('/transactions', function(request, response, next) {
  // Pull transactions for the Item for the last 120 days
